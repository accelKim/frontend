...
const AuthContext = React.createContext({
    ...
    isSuccess: false,
    isGetSuccess: false,
    signup: (email: string, password: string, nickname:string, phone:string) =>  {},
...
export const AuthContextProvider:React.FC<Props> = (props) => {
    ...
    const signupHandler = (email:string, password: string, nickname: string, phone:string) => {
        setIsSuccess(false);
        const response = authAction.signupActionHandler(email, password, nickname, phone);
    ...
    useEffect(() => {
        if (tokenData && typeof tokenData.duration === 'number' && !isNaN(tokenData.duration)) {
